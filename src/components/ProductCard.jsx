...
export default function ProductCard({ product, index = 0 }) {
  ...
  return (
    ...
    >
      {/* ── Image + name/description: navigates to product page ── */}
      <Link to={productUrl} className="block">
        ...
        {/* ── Card Content (no interactive children) ─────────────── */}
        <div className="px-4 pt-4 pb-2">
          ...
          <h3 className="font-inter font-semibold text-slate-800 text-sm leading-tight mb-1.5">
            {product.name}
          </h3>
      ...
      {/* ── Price + WhatsApp CTA — sibling to Link, not nested ─── */}
